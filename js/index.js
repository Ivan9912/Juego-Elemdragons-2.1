...
function trampa () {
    ...
    if (i % 2 || i == 1) {
        ...
        trampa.innerHTML = `
        <p> 
            Aquí se generará la elección de la PC de su dragón.<br> 
        </p> 
        <p> 
            <button id = "boton-pc">
...
mascotasEleccion.push(new Mascotas(`Dragón N1`,`Agua`, 1010, 60,16,05,06,098));
mascotasEleccion.push(new Mascotas(`Dragón N2`,`Tierra`, 1020, 60,15,05,06,097));
mascotasEleccion.push(new Mascotas(`Dragón N3`,`Fuego`, 1030, 60,14,05,06,096));
mascotasEleccion.push(new Mascotas(`Dragón N4`,`Agua y Fuego`, 1040, 60,13,05,06,095));
mascotasEleccion.push(new Mascotas(`Dragón N5`,`Agua y Tierra`, 1050, 60,12,05,06,094));
mascotasEleccion.push(new Mascotas(`Dragón N6`,`Tierra y Fuego`, 1060, 60,11,05,06,093));
