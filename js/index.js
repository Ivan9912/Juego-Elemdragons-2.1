...
let fuego = `<button id = "boton-fuego" onclick = elementoFuego() class = "boton-elementos" id = "boton-fuego"> Fuego 🔥 </button>`;
let agua = `<button id = "boton-agua" onclick = elementoAgua() class = "boton-elementos" id = "boton-agua"> Agua 💧</button>`;
let tierra = `<button id = "boton-tierra" onclick = elementoTierra() class = "boton-elementos" id = "boton-tierra"> Tierra ☘</button>`;
